...
export const troopImages: Record<string, string> = {
  ...
  // Updated mappings based on exact text in images - both singular and plural forms
  "Goblins": "/lovable-uploads/85257d8e-6c03-410b-a5f5-862453f2d000.png",
  "Goblin": "/lovable-uploads/85257d8e-6c03-410b-a5f5-862453f2d000.png", // singular form
  ...
  "Archer": "/lovable-uploads/961563d0-843e-42b4-b556-5a2481c5944d.png" // singular form
};
